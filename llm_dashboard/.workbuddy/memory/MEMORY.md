...
- **v20260817改动**: 板块六新增广告活动筛选器(msCampaign, 局部筛选) + 关键词表按广告活动名分组排序(先取Top20再按活动名分组)；日期范围 2026-06-01 ~ 08-15
...
4. 板块四：广告类型对比
5. 板块五：匹配方式分析
6. 板块六：关键词优化 (浪费词/高ACoS/优质词 Top20, 按广告活动分组排列 + 广告活动筛选器 2026-08-17新增)
7. 板块七：优化建议与行动措施
